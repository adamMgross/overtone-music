...
(defn solo3 [m beat-num notes instr-play]
  (at (m (+ 1 beat-num)) (instr-play :c4))
  (at (m (+ 3 beat-num)) (instr-play :e4))
  (at (m (+ 4 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 5 beat-num)) (instr-play :g4))
  (at (m (+ 7 beat-num)) (instr-play :e5))
  (at (m (+ 8 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 8.5 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 9 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 11 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 12 beat-num)) (instr-play :b4))
  (at (m (+ 12.5 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 13.5 beat-num)) (instr-play :g4))
  (at (m (+ 14 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 14.5 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 15 beat-num)) (instr-play :c4)))

;; plays a harmony to solo3
(defn solo3-harmony [m beat-num notes instr-play]
  (at (m (+ 1 beat-num)) (instr-play :e4))
  (at (m (+ 1 beat-num)) (instr-play :b4))
  (at (m (+ 4 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 5 beat-num)) (instr-play :g4))
  (at (m (+ 5 beat-num)) (instr-play :e5))
  (at (m (+ 9 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 11 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 12 beat-num)) (instr-play :b4))
  (at (m (+ 12.5 beat-num)) (instr-play (choose-rand notes)))
...
;; plays a harmony to solo3
(defn minor-solo [m beat-num notes instr-play]
  (at (m (+ 1 beat-num)) (instr-play :a4))
  (at (m (+ 1.5 beat-num)) (instr-play :g4))
  (at (m (+ 2.5 beat-num)) (instr-play :c5))
  (at (m (+ 3 beat-num)) (instr-play :g4))
  (at (m (+ 3.5 beat-num)) (instr-play :e5))
  (at (m (+ 3.75 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 4 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 4.5 beat-num)) (instr-play :b4))
  (at (m (+ 5.5 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 6 beat-num)) (instr-play :g4))
  (at (m (+ 7 beat-num)) (instr-play (choose-rand notes)))
  (at (m (+ 7.5 beat-num)) (instr-play :ab4)))

(defn minor-solo-alt [m beat-num notes instr-play]
  (at (m (+ 1 beat-num)) (instr-play :a4))
  (at (m (+ 1.5 beat-num)) (instr-play :g4))
  (at (m (+ 2.5 beat-num)) (instr-play :c5))
  (at (m (+ 3 beat-num)) (instr-play :g4))
...
;; the drum, bass, and chord progression for the second hook
(defn minor-transition [m beat-num]
  (at (m (+ 0 beat-num)) (kick))
  (at (m (+ 1 beat-num)) (play-chord-inst (chord :a3 :minor) overpad))
  (at (m (+ 1 beat-num)) (tb-bass :a2))
  (at (m (+ 3 beat-num)) (tb-bass :ab2))
  (at (m (+ 4 beat-num)) (kick))
  (at (m (+ 4 beat-num)) (kill buzz))
  (at (m (+ 5 beat-num)) (play-chord-inst (chord :g3 :6) overpad))
  (at (m (+ 5 beat-num)) (tb-bass :g2))
  (at (m (+ 7.5 beat-num)) (tb-bass :gb2))
  (at (m (+ 8 beat-num)) (tb-bass :g2))
  (at (m (+ 8 beat-num)) (kill buzz)))
...
(defn execute-song []
  (do
    ...
    ;; second solo (with harmony)
    (hook2 metro (+ 96 (metro)))
    (hook2 metro (+ 104 (metro)))
    (solo3 metro (+ 96 (metro)) note-selection piano-play)
    (solo3-harmony metro (+ 96 (metro)) note-selection piano-play)

    ;; break
    (hook2 metro (+ 112 (metro)))
    (hook2 metro (+ 120 (metro)))

    ;; minor solo on breakdown
    (minor-solo metro (+ 128  (metro)) note-selection overpad-play)
    (minor-transition metro (+ 128 (metro)))

    (minor-solo-alt metro (+ 136 (metro)) note-selection overpad-play)
    (minor-transition metro (+ 136 (metro)))

    ;; conituned monor solo over verse progression
    (minor-solo metro (+ 144  (metro)) note-selection overpad-play)
    (verse-loop metro (+ 144 (metro)))
    (minor-solo-alt metro (+ 152 (metro)) note-selection overpad-play)
    (verse-loop metro (+ 152 (metro)))

    ;; outro
    (verse-loop metro (+ 160 (metro)))
    (lead-line metro (+ 160 (metro)) piano-play)
    (verse-loop metro (+ 168 (metro)))
    (verse-loop metro (+ 176 (metro)))
    (verse-loop metro (+ 188 (metro)))
  ))
